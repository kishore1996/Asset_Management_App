...
import com.asset_management_app.assetsdb.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("AssetsDB.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/AssetsDB/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("AssetsDB.DepartmentService")
    ...
    public Department editDepartment(@PathVariable("id") Integer id, @RequestBody Department department) {
        LOGGER.debug("Editing Department with id: {}" , department.getId());
    ...
    public Page<Requested> findAssociatedRequesteds(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return departmentService.findAssociatedRequesteds(id, pageable);
    }
