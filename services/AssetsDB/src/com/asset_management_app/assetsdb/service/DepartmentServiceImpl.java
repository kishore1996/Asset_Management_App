...
import com.asset_management_app.assetsdb.Department;
 ...
 * @see Department
 */
@Service("AssetsDB.DepartmentService")
@Validated
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Autowired
    @Qualifier("AssetsDB.DepartmentDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service AssetsDB for table Department to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service AssetsDB for table Department to {} format", options.getExportType());
    ...
    @Transactional(readOnly = true, value = "AssetsDBTransactionManager")
    @Override
    public Page<Requested> findAssociatedRequesteds(Integer id, Pageable pageable) {
        LOGGER.debug("Fetching all associated requesteds");

        StringBuilder queryBuilder = new StringBuilder();
        queryBuilder.append("department.id = '" + id + "'");
